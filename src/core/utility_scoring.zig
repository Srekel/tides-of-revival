...
pub const Gradient = struct {
    ...
    colors: [colors_count_max]fd.ColorRGB = undefined,
    positions: [colors_count_max]f32 = undefined,
    colors_count: u32 = 0,

    pub fn sample(self: *Gradient, t: f32) fd.ColorRGB {
        ...
        for (1..colors_count_max) |color_index| {
            ...
            color = fd.ColorRGB.lerp(color, self.colors[color_index], color_position);
        }
