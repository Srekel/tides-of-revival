...
pub fn initPrefabs(prefab_mgr: *prefab_manager.PrefabManager, ecsu_world: ecsu.World) void {
    ...
    prefab_mgr.rctx.loadMaterial(default_material_id.hash, default_material) catch unreachable;
        ...
        if (lod_group_component) |lod_group| {
            for (0..lod_group.lod_count) |i| {
                for (0..lod_group.lods[i].materials_count) |material_index| {
                    lod_group.lods[i].materials[material_index] = default_material_id.hash;
                }
            }
        }
    }

    {
        ...
        prefab_mgr.rctx.loadMaterial(material_id.hash, material) catch unreachable;

        {
            ...
            if (lod_group_component) |lod_group| {
                for (0..lod_group.lod_count) |i| {
                    ...
                    lod_group.lods[i].materials[0] = material_id.hash;
                }
            }
        }
...

    {
        ...
        if (lod_group_component) |lod_group| {
            for (0..lod_group.lod_count) |i| {
                std.debug.assert(lod_group.lods[i].materials_count == 1);
                lod_group.lods[i].materials[0] = default_material_id.hash;
            }
        }
    }
    ...
    slime_body_material.albedo = prefab_mgr.rctx.loadTexture("prefabs/creatures/slime/slime_body_diffuse.dds");
    prefab_mgr.rctx.loadMaterial(slime_body_material_id.hash, slime_body_material) catch unreachable;
    ...
    slime_eyes_material.albedo = prefab_mgr.rctx.loadTexture("prefabs/creatures/slime/slime_eyes_diffuse.dds");
    prefab_mgr.rctx.loadMaterial(slime_eyes_material_id.hash, slime_eyes_material) catch unreachable;

    const slime_trail_material_id = ID("slime_trail");
    var slime_trail_material = renderer.UberShaderMaterialData.initNoTexture(fd.ColorRGB.init(1.0, 1.0, 1.0), 0.3, 0.0);
    slime_trail_material.gbuffer_pipeline_id = pipeline_lit_gbuffer_opaque_id;
    slime_trail_material.shadow_caster_pipeline_id = pipeline_shadow_caster_opaque_id;
    slime_trail_material.albedo = prefab_mgr.rctx.loadTexture("prefabs/creatures/slime/slime_trail_diffuse.dds");
    prefab_mgr.rctx.loadMaterial(slime_trail_material_id.hash, slime_trail_material) catch unreachable;

    {
        ...
        if (lod_group_component) |lod_group| {
            for (0..lod_group.lod_count) |i| {
                ...
                lod_group.lods[i].materials[0] = slime_body_material_id.hash;
                lod_group.lods[i].materials[1] = slime_eyes_material_id.hash;
            }
        }
    }

    {
        ...
        if (lod_group_component) |lod_group| {
            for (0..lod_group.lod_count) |i| {
                std.debug.assert(lod_group.lods[i].materials_count == 1);
                lod_group.lods[i].materials[0] = slime_trail_material_id.hash;
            }
        }
    }

    {
        ...
        prefab_mgr.rctx.loadMaterial(beech_trunk_04_material_id.hash, beech_trunk_04_material) catch unreachable;
        ...
        prefab_mgr.rctx.loadMaterial(beech_atlas_v2_material_id.hash, beech_atlas_v2_material) catch unreachable;
        ...
        prefab_mgr.rctx.loadMaterial(beech_04_impostor_material_id.hash, beech_04_impostor_material) catch unreachable;
        ...
        renderable_desc.lods[0].materials[0] = beech_trunk_04_material_id.hash;
        renderable_desc.lods[0].materials[1] = beech_atlas_v2_material_id.hash;
        ...
        // renderable_desc.lods[1].materials[0] = beech_trunk_04_material_id.hash;
        // renderable_desc.lods[1].materials[1] = beech_atlas_v2_material_id.hash;
        ...
        renderable_desc.lods[2].materials[0] = beech_04_impostor_material_id.hash;
...

    {
        ...
        prefab_mgr.rctx.loadMaterial(stacked_stone_material_id.hash, stacked_stone_material) catch unreachable;
        ...
        renderable_desc.lods[0].materials[0] = stacked_stone_material_id.hash;
...

    {
        ...
        prefab_mgr.rctx.loadMaterial(wood_trim_material_id.hash, wood_trim_material) catch unreachable;
        ...
        prefab_mgr.rctx.loadMaterial(plaster_material_id.hash, plaster_material) catch unreachable;
        ...
        prefab_mgr.rctx.loadMaterial(brick_material_id.hash, brick_material) catch unreachable;
        ...
        prefab_mgr.rctx.loadMaterial(uneven_brick_material_id.hash, uneven_brick_material) catch unreachable;
        ...
        prefab_mgr.rctx.loadMaterial(flat_tiles_material_id.hash, flat_tiles_material) catch unreachable;
        ...
        prefab_mgr.rctx.loadMaterial(round_tiles_material_id.hash, round_tiles_material) catch unreachable;
        ...
        // prefab_mgr.rctx.loadMaterial(window_glass_material_id.hash, window_glass_material) catch unreachable;
        ...
        prefab_mgr.rctx.loadMaterial(rock_trim_material_id.hash, rock_trim_material) catch unreachable;
        ...
        prefab_mgr.rctx.loadMaterial(metal_ornaments_material_id.hash, metal_ornaments_material) catch unreachable;
        ...
        renderable_desc.lods[0].materials[0] = wood_trim_material_id.hash;
        renderable_desc.lods[0].materials[1] = plaster_material_id.hash;
        renderable_desc.lods[0].materials[2] = brick_material_id.hash;
        renderable_desc.lods[0].materials[3] = flat_tiles_material_id.hash;
        renderable_desc.lods[0].materials[4] = round_tiles_material_id.hash;
        renderable_desc.lods[0].materials[5] = rock_trim_material_id.hash;
        renderable_desc.lods[0].materials[6] = wood_trim_material_id.hash;
        renderable_desc.lods[0].materials[7] = metal_ornaments_material_id.hash;
        renderable_desc.lods[0].materials[8] = uneven_brick_material_id.hash;
        // renderable_desc.lods[0].screen_percentage_range[0] = 0.0;
        // renderable_desc.lods[0].screen_percentage_range[1] = 1.0;
        renderable_desc.lods[0].screen_percentage_range[0] = 0.0;
        renderable_desc.lods[0].screen_percentage_range[1] = 30000.0;
...

    {
        ...
        renderable_desc.lods[0].materials_count = 2;
        renderable_desc.lods[0].materials[0] = wood_trim_material_id.hash;
        renderable_desc.lods[0].materials[1] = metal_ornaments_material_id.hash;
        // renderable_desc.lods[0].screen_percentage_range[0] = 0.0;
        // renderable_desc.lods[0].screen_percentage_range[1] = 1.0;
        renderable_desc.lods[0].screen_percentage_range[0] = 0.0;
        renderable_desc.lods[0].screen_percentage_range[1] = 30000.0;
...

    {
        ...
        wood_trim_material.arm = prefab_mgr.rctx.loadTexture("prefabs/buildings/medieval_village/houses/T_WoodTrim_Roughness.dds");
        wood_trim_material.normal = prefab_mgr.rctx.loadTexture("prefabs/buildings/medieval_village/houses/T_WoodTrim_Normal.dds");
        prefab_mgr.rctx.loadMaterial(campfire_wood_trim_material_id.hash, wood_trim_material) catch unreachable;
        ...
        metal_ornaments_material.albedo = prefab_mgr.rctx.loadTexture("prefabs/buildings/medieval_village/houses/T_MetalOrnaments_BaseColor.dds");
        metal_ornaments_material.arm = prefab_mgr.rctx.loadTexture("prefabs/buildings/medieval_village/houses/T_MetalOrnaments_Roughness.dds");
        prefab_mgr.rctx.loadMaterial(campfire_metal_ornaments_material_id.hash, metal_ornaments_material) catch unreachable;

        const lod_group_component = campfire.getMut(fd.LodGroup);
        if (lod_group_component) |lod_group| {
            for (0..lod_group.lod_count) |i| {
                std.debug.assert(lod_group.lods[i].materials_count == 2);
                lod_group.lods[i].materials[0] = campfire_wood_trim_material_id.hash;
                lod_group.lods[i].materials[1] = campfire_metal_ornaments_material_id.hash;
            }
        }
...

    {
        ...
        prefab_mgr.rctx.loadMaterial(lamp_plaster_material_id.hash, plaster_material) catch unreachable;
        ...
        if (lamp_lod_group_component) |lod_group| {
            for (0..lod_group.lod_count) |i| {
                std.debug.assert(lod_group.lods[i].materials_count == 2);
                lod_group.lods[i].materials[0] = lamp_plaster_material_id.hash;
                lod_group.lods[i].materials[1] = campfire_metal_ornaments_material_id.hash;
            }
        }
