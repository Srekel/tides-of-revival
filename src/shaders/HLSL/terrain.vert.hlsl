...
#if 0
    float height_0 = heightmap.SampleLevel(g_linear_clamp_edge_sampler, Out.UV, 0).r;
    float height_1 = heightmap.SampleLevel(g_linear_clamp_edge_sampler, Out.UV, 0, int2(1, 0)).r;
    float height_2 = heightmap.SampleLevel(g_linear_clamp_edge_sampler, Out.UV, 0, int2(0, 1)).r;
...
#else
    float zb = heightmap.SampleLevel(g_linear_clamp_edge_sampler, Out.UV, 0, int2(0, -1)).r;
    float zc = heightmap.SampleLevel(g_linear_clamp_edge_sampler, Out.UV, 0, int2(1, -1)).r;
    float zd = heightmap.SampleLevel(g_linear_clamp_edge_sampler, Out.UV, 0, int2(1, 0)).r;
    float ze = heightmap.SampleLevel(g_linear_clamp_edge_sampler, Out.UV, 0, int2(1, 1)).r;
    float zf = heightmap.SampleLevel(g_linear_clamp_edge_sampler, Out.UV, 0, int2(0, 1)).r;
    float zg = heightmap.SampleLevel(g_linear_clamp_edge_sampler, Out.UV, 0, int2(-1, 1)).r;
    float zh = heightmap.SampleLevel(g_linear_clamp_edge_sampler, Out.UV, 0, int2(-1, 0)).r;
    float zi = heightmap.SampleLevel(g_linear_clamp_edge_sampler, Out.UV, 0, int2(-1, -1)).r;
